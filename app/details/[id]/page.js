    ...
    <div className='flex flex-wrap    w-full h-[650px] relative'>
        {
            users && users.map((u) =>(
                <>
                    ...
                    <div className="absolute z-10 top-5 font-['Coco'] text-6xl w-[800px] pl-6 max-[425px]:relative max-[425px]:top-0 max-[425px]:text-4xl max-[425px]:h-5" >{u.name}</div>
                    ...
                    <div className='absolute z-10 top-60 bg-violet-900 ml-6 p-3 rounded-2xl max-[425px]:relative max-[425px]:top-0 max-[425px]:h-[105px]'>
